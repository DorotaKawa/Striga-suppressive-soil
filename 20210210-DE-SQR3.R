...
save(cpmExpression,file = "0.DEG2021/SQR3/cpmExpression_SQR3.RData")
save(voomExpression,file = "0.DEG2021/SQR3/voomExpression_SQR3.RData")
write.table(cpmExpression, file = "0.DEG2021/SQR3/voomExpression_SQR3.csv",sep = ",",quote = F,col.names = T )
...
write.table( significantDE[["N"]],file = "0.DEG2021/SQR3/SQR3_Soil.csv",sep = ",",quote = F,col.names = T)
write.table( significantDE[["STRIGA"]],file = "0.DEG2021/SQR3/SQR3_Striga.csv",sep = ",",quote = F,col.names = T)
write.table( significantDE[["NSTRIGA"]],file = "0.DEG2021/SQR3/SQR3_SoilXStriga.csv",sep = ",",quote = F,col.names = T)
